odoo.define('web.OwlDialog', function (require) {
    ...
    // Owl Dialog Component from Odoo 14

    // const patchMixin = require('web.patchMixin');

    const { Component, hooks, misc, tags } = owl;
    const { Portal } = misc;
    ...
    class Dialog extends Component {
        ...
        mounted() {
            ...
            // TODO: this.env.bus.on('close_dialogs', this, this._close);
        ...
        willUnmount() {
            // TODO: this.env.bus.off('close_dialogs', this, this._close);
