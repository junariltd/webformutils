...
define("jowebutils.testapp.FormTester", ["require", "exports", "@odoo/owl"], function (require, exports, owl_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FormTester = void 0;
    class FormTester extends owl_1.Component {
    }
    exports.FormTester = FormTester;
    FormTester.template = owl_1.tags.xml /* xml */ `
    <div class="container">
        <div class="row">
...
define("jowebutils.testapp.main", ["require", "exports", "@odoo/owl", "jowebutils.testapp.FormTester"], function (require, exports, owl_2, FormTester_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // import { WidgetsTester } from './pages/WidgetsTester';
    owl_2.mount(FormTester_1.FormTester, { target: document.getElementById('app') });
});
///<amd-module name='jowebutils.widgets.Table'/>
define("jowebutils.widgets.Table", ["require", "exports", "@odoo/owl"], function (require, exports, owl_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Table = void 0;
    class Table extends owl_3.Component {
        formatValue(value) {
    ...
    exports.Table = Table;
    Table.template = owl_3.tags.xml /* xml */ `
...
define("jowebutils.testapp.WidgetsTester", ["require", "exports", "@odoo/owl", "jowebutils.widgets.Table"], function (require, exports, owl_4, Table_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.WidgetsTester = void 0;
    class WidgetsTester extends owl_4.Component {
        constructor() {
            super(...arguments);
    ...
    WidgetsTester.template = owl_4.tags.xml /* xml */ `
    <div class="container">
        <div class="row">
...
define("jowebutils.owl_app", ["require", "exports", "web.public.widget", "web.rpc", "web.session", "web.OwlCompatibility", "@odoo/owl"], function (require, exports, publicWidget, rpc, session, web_OwlCompatibility_1, owl_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createOWLApp = void 0;
    class App extends owl_5.Component {
    }
    App.components = { RouteComponent: owl_5.router.RouteComponent };
    App.template = owl_5.tags.xml `<RouteComponent />`;
    function createOWLApp(appDef) {
        return publicWidget.Widget.extend(web_OwlCompatibility_1.WidgetAdapterMixin, {
            ...
            init: function () {
                ...
                env.router = new owl_5.router.Router(this.owl_component.env, appDef.routes);
                this.populateOWLEnv();
            },
            ...
            initOWLQWeb: async function () {
                ...
                if (appDef.xmlDependencies) {
                    for (let dep of appDef.xmlDependencies) {
                        loadPromises.push(owl_5.utils.loadFile(dep));
                    }
                }
...
define("jowebutils.forms.Form", ["require", "exports", "@odoo/owl"], function (require, exports, owl_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Form = void 0;
    class Form extends owl_6.Component {
        constructor() {
            super(...arguments);
            ...
            const formContextContainer = new owl_6.Context(formContextData);
    ...
    exports.Form = Form;
    Form.template = owl_6.tags.xml /* xml */ `
...
define("jowebutils.forms.Fields", ["require", "exports", "@odoo/owl"], function (require, exports, owl_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FormField = exports.TagField = exports.SelectField = exports.BooleanField = exports.CharField = exports.BaseField = void 0;
    class BaseField extends owl_7.Component {
        constructor() {
            super(...arguments);
            this.state = owl_7.hooks.useState({
                value: null
            });
            this.form = owl_7.hooks.useContext(this.env.formContext);
    ...
    class FieldWrapper extends owl_7.Component {
    }
    FieldWrapper.template = owl_7.tags.xml /* xml */ `
...
`;
    ...
    CharField.template = owl_7.tags.xml /* xml */ `
...
`;
    ...
    BooleanField.template = owl_7.tags.xml /* xml */ `
    <FieldWrapper field="props.field">
        <input
            t-if="!props.field.readonly"
            type="checkbox"
...
`;
    ...
    SelectField.template = owl_7.tags.xml /* xml */ `
    <FieldWrapper field="props.field">
        <select
            t-if="!props.field.readonly"
            class="form-control"
...
`;
    ...
    TagField.template = owl_7.tags.xml /* xml */ `
<FieldWrapper field="props.field">
...
`;
    class FormField extends owl_7.Component {
    }
    exports.FormField = FormField;
    FormField.components = { CharField, BooleanField, SelectField, TagField };
    FormField.template = owl_7.tags.xml /* xml */ `
    <div>
